...
@media(min-width:1400px){.toc{gap:8px}.toc a{width:auto;gap:12px;height:22px}.toc a span{position:static;transform:none;opacity:1;pointer-events:auto;background:rgba(255,255,255,.9);box-shadow:0 1px 2px rgba(20,26,31,.08);padding:3px 9px;border-radius:7px;font:500 13px Inter,sans-serif;color:#5B6570}.toc a:hover span{color:var(--ink);transform:none}.toc a.on span{color:var(--ink);font-weight:600}}
