...
TITLES = ["Dominate SERPs for 4 categories", "Where Paybooks stands", "The prize", "Category 1 research",
          "Diagnosis", "Category 1 strategy", "Proof of work", "Scope", "Quotation", "Next step"]
...
LINKS = {
    ...
    10: [("https://www.linkedin.com/in/mohankumarallada/", [[1325, 920, 467, 31]])],
}
...
dots = "".join(f'<button class="dot{" on" if i == 1 else ""}" data-go="{i}" aria-label="Go to slide {i}"></button>' for i in range(1, 11))
