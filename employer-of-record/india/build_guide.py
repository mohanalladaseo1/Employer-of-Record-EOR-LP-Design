...
TOC = ('<aside class="g-toc" aria-label="Contents"><h2>On this page</h2><ol>' + toc + '</ol>'
       '<div class="g-toc-cta"><b>What will your India hire cost?</b><p>Salary, PF, ESI, gratuity and fees, with worked examples in rupees and dollars.</p><a class="btn" href="#cost">See the cost breakdown</a></div></aside>')
